export default function SelectorCitas({ listaDeCitas, seleccionarCita,selectCita,reservarCita,resetForm }) {
    return (
        <>
            <div>
                ...
                <div className="bg-green-400 m-10 p-4 rounded-lg">
                    <button c
                        ...
                        lassName="bg-slate-500 px-2 py-1 ml-4 text-white rounded">
                        Reservar Cita
                    </button>
                    <button 
                        onClick={resetForm}
